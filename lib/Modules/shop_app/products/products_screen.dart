...
import 'package:course_training/Shared/styles/colors.dart';
...
class ProductsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ShopCubit, ShopStates>(
      ...
      builder: (context, state){
        return (state is ShopCubit.get(context).homeModel)? Center(child: CircularProgressIndicator(),):productsBuilder(
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20.0,), //maybe its not here
  ...
  Widget buildCategoryItem(DataModel model) => Stack(
    ...
    children: [
      Image(image: NetworkImage(model.image),height: 100.0,width: 100.0,fit: BoxFit.cover,),
      Container(
